...
print(f"Area if a circle with radius {radius}m: {area_of_circle:.2f} meters")

# 2. circumference = 2 * math.pi * radius 
circumference = 2 * math.pi * radius
print(f"Circumference of a circle with radius {radius}m: {circumference:.2f} meters")

# 3. take radius as uder input and calculate the area
user_radius = float(input("Enter the radius of the circle: "))
user_area = math.pi * user_radius ** 2
print(f"Area of a circle with radius {user_radius}m: {user_area} meters")

# 13 Ask user for first name, last name, country and age 

user_name_first = input("Enter name please: ")
